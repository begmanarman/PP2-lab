...
background = pygame.image.load("/Users/armanbegman/Desktop/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/armanbegman/Desktop/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/armanbegman/Desktop/coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/armanbegman/Desktop/Player.png")
        self.rect = self.image.get_rect()
